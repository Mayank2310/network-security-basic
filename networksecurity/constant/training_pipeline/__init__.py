...
DATA_TRASFORMATION_TRANSFORMED_DATA_DIR: str = "transformed"
...
"""
Model trainer related constant start with MODER TRAINER VAR NAME
...
MODEL_TRAINER_OVER_FITTING_UNDER_THRESHOLD: float = "0.05"
